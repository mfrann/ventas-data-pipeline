...
# TODO: Convertir columnas de FECHAS de texto a DATATIME, para operaciones temporales. ✓✓✓ COMPLETADO ✓✓✓
def convert_time():
    ...
    print("✓ Ventas: fecha convertida")

    # *--- PARA CLIENTES.CSV 
    df_clientes['fecha_registro'] = pd.to_datetime(df_clientes['fecha_registro'])
    print("✓ Clientes: fecha_registro convertida")

    # *--- PARA VENDEDORES.CSV 
    df_vendedores['fecha_ingreso'] = pd.to_datetime(df_vendedores['fecha_ingreso'])
    print("✓ Vendedores: fecha_ingreso convertida")

    print("✓ Todas las fechas convertidas")

convert_time()
print("\n=== VERIFICACIÓN DE TIPOS ===")
print(f"Tipo de fecha en ventas: {df_ventas['fecha'].dtype}")
print(f"Tipo de fecha_registro en clientes: {df_clientes['fecha_registro'].dtype}")
print(f"Tipo de fecha_ingreso en vendedores: {df_vendedores['fecha_ingreso'].dtype}")
print("===" * 20)
print(f"\nEjemplo - Año de primera venta: {df_ventas['fecha'].iloc[0].year}")